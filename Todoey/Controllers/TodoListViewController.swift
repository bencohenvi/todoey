...
class TodoListViewController: SwipeTableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationController?.navigationBar.tintColor = ContrastColorOf(UIColor(hexString: category!.color)!, returnFlat: true)
        navigationController?.navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: ContrastColorOf(UIColor(hexString: category!.color)!, returnFlat: true)]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let item = itemsArray?[indexPath.row] {
            ...
            if let color = UIColor(hexString: category!.color)?.darken(byPercentage: CGFloat(indexPath.row) / CGFloat(itemsArray!.count)) {
